...
export default function Projects() {
    ...
    const newsportal = "https://albertturon1.github.io/newsportal/";
    ...
    return (
        <div className="my-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-y-10 gap-x-5 sm:gap-x-8">
                <Item description='React Native, Postgres, Firebase, Node.js' link={app} image={"https://res.cloudinary.com/dschnp3gj/image/upload/v1654018593/Screenshot_32_w4awuj.png"} title="Aplikacja społecznościowa - Lipiec 2022" active/>
...
const Item = ({ title, date, remasterDate, description, image, link, alt, active }) => {
    ...
    return (
        <div>
            ...
            <p className="text-gray-600 text-sm">Technologie: {description}</p>
